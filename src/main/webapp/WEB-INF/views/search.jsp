...
<div id="content">
    <div class="wrap">
        ...
        <div id="menu">
            <ul class="ca-menu">
                <li>
                    <a href="bookList?jspPage=search">
                ...
                <li>
                    <a href="seriesList?jspPage=search">
            ...
            <div id="posts-list">
                                ...
                                <div class="block_button">
                                     <sec:authorize access="isAuthenticated()">
                                        <sec:authorize access="hasRole('ROLE_USER')">
                                         ...
                                         <sec:authorize access="hasRole('ROLE_ADMIN')">
                                        <c:if test="${book.getIsInCollection() == 0}">
                ...
                <c:forEach var="pageNum" items="${map.listPageNum}">
                    <c:if test="${pageNum == map.currentPage.get(0)}">
                        <a href="search?pageNumber=${pageNum}" style="text-decoration: underline">${pageNum}</a>&nbsp
                    </c:if>
                    <c:if test="${pageNum != map.currentPage.get(0)}">
                        <a href="search?pageNumber=${pageNum}" >${pageNum}</a>&nbsp
                    </c:if>
                </c:forEach>
                </center>
            </div>
